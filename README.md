...
# Credits
Annalisa Milella (CNR-STIIMA) and Giulio Reina (Politecnico of Bari) developed the sensing system, conceived and performed the experiments, and contributed to dataset generation and maintenance.  Arianna Rana and Antonio Petitti (CNR-STIIMA) contributed to the development of the sensing system and to dataset generation and maintenance. Francesco F. Montesano (UNIBA) conceived the experimental design and field setup. Sysman Progetti & Servizi S.r.l. is gratefully acknowledged for hosting experimental tests and for support during data collection.
